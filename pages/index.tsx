    ...
    <div className="min-h-screen flex flex-col items-center justify-center">
      ...
      <main className="pb-20 w-full flex flex-1 flex-col items-center justify-center">
        ...
        <div className="w-full max-w-[2000px] m-auto px-8">
          ...
          <div className="mt-24 flex max-lg:flex-col flex-row gap-x-10 gap-y-4 items-top">
            <div className="flex flex-row flex-wrap text-left justify-center align-middle max-lg:items-center items-top gap-x-10 gap-y-6">
              <Image src={SiteURL + "/william-perry.png"} alt="" width={300} height={300} className="mt-2 max-w-[300px] max-h-[300px]" />
          ...
          <div className="mt-24 flex flex-row max-md:flex-col gap-10 items-top">
          ...
          <p className="my-4 text-2xl text-justify">Are you ready to begin piano lessons at Woodmont Piano Studio?</p>
          <div className="mt-4 mb-8 px-6 py-8 bg-[#f3f3f3] shadow-md text-center">
            <p className="text-2xl text-justify">Send William Perry an email at <LinkExternal className="break-all" href="mailto:contact@woodmontpiano.com" title="Email William Perry at Contact@WoodmontPiano.com">Contact@WoodmontPiano.com</LinkExternal></p>
          </div>

          <h2 id="ready-to-start" className="mt-32 text-4xl font-bold">Already a Student?</h2>
          <p className="my-4 text-2xl text-justify">Looking for the login to see your Woodmont Piano Studio account?</p>
